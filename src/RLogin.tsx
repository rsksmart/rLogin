...
export class RLogin {
  ...
  private onConnect = (provider: any, disconnect: () => void, dataVault?: DataVault, selectedLanguage?:string) => this.handleOnAndTrigger(CONNECT_EVENT, { provider, disconnect, dataVault, selectedLanguage })
