/**
 * Class & ID Selectors
 * These selectors can be used by the developer to change the any of the styles
 * using CSS.
 */

// Modal
export const WEB3_CONNECT_MODAL_ID = 'rlogin-connect-modal'
export const MODAL_LIGHTBOX_CLASSNAME = 'rlogin-modal-lightbox'
...
export const BUTTON_SECONDARY_CLASSNAME = 'rlogin-button-secondary'
